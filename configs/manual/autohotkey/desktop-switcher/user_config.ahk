...
CapsLock & z::MoveCurrentWindowToDesktop(1)
CapsLock & x::MoveCurrentWindowToDesktop(2)
CapsLock & c::MoveCurrentWindowToDesktop(3)
CapsLock & v::MoveCurrentWindowToDesktop(4)
CapsLock & b::MoveCurrentWindowToDesktop(5)
CapsLock & n::MoveCurrentWindowToDesktop(6)
CapsLock & m::MoveCurrentWindowToDesktop(7)
CapsLock & ,::MoveCurrentWindowToDesktop(8)
CapsLock & .::MoveCurrentWindowToDesktop(9)
