return {
  ...
  ['<cr>'] = { "coc#pum#visible() ? coc#pum#confirm() : '<cr>'", 'Confirm while in Coc list', mode = 'i', expr = true },
  ...
  ['<m-l>'] = { '<cmd>bnext<cr>', 'Go to next buffer' },
  ['<m-h>'] = { '<cmd>bprevious<cr>', 'Go to previos buffer' },
